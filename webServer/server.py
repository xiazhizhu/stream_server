...
def post_method_info():
	...
	try:
		...
		# print 'getAddress callback error'
		# return jsonify(
		...
		if len(str(ret[1])) == 0:
			...
			try:
				...
				# print 'setAllowStreamlist callback error'
		return jsonify(
		status=get_status,
		exist=ret[0],
		liveType=0,
